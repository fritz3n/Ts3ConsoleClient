...
namespace FragLabs.Audio.Codecs
{
    ...
    public class Opusencoder : IDisposable
    {
        ...
        public static Opusencoder Create(int outputSampleRate, int outputChannels)
        {
            ...
            return new Opusencoder(decoder, outputSampleRate, outputChannels);
        }

        private IntPtr _decoder;

        private Opusencoder(IntPtr decoder, int outputSamplingRate, int outputChannels)
        {
            _decoder = decoder;

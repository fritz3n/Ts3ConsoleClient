...
namespace TS3Client.Messages
{
	...
	public sealed class ChannelDeleted : INotification  
	{
		...
		public ChannelIdT ChannelId { get; set; }		public ClientIdT InvokerId { get; set; }		public string InvokerName { get; set; }		public ClientUidT InvokerUid { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "cid": ChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "invokerid": InvokerId = CommandDeserializer.DeserializeUInt16(value); break;			case "invokername": InvokerName = CommandDeserializer.DeserializeString(value); break;			case "invokeruid": InvokerUid = CommandDeserializer.DeserializeString(value); break;			
			}
		}
	}
	public sealed class ChannelEdited : INotification  
	{
		...
		public ChannelIdT ChannelId { get; set; }		public ClientIdT InvokerId { get; set; }		public string InvokerName { get; set; }		public ClientUidT InvokerUid { get; set; }		public int Order { get; set; }		public string Name { get; set; }		public string Topic { get; set; }		public bool IsDefaultChannel { get; set; }		public bool HasPassword { get; set; }		public bool IsPermanent { get; set; }		public bool IsSemiPermanent { get; set; }		public Codec Codec { get; set; }		public int CodecQuality { get; set; }		public int NeededTalkPower { get; set; }		public long IconId { get; set; }		public int MaxClients { get; set; }		public int MaxFamilyClients { get; set; }		public int CodecLatencyFactor { get; set; }		public bool IsUnencrypted { get; set; }		public TimeSpanSecondsT DeleteDelay { get; set; }		public bool IsMaxClientsUnlimited { get; set; }		public bool IsMaxFamilyClientsUnlimited { get; set; }		public bool IsMaxFamilyClientsInherited { get; set; }		public string PhoneticName { get; set; }		public MoveReason Reason { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "cid": ChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "invokerid": InvokerId = CommandDeserializer.DeserializeUInt16(value); break;			case "invokername": InvokerName = CommandDeserializer.DeserializeString(value); break;			case "invokeruid": InvokerUid = CommandDeserializer.DeserializeString(value); break;			case "channel_order": Order = CommandDeserializer.DeserializeInt32(value); break;			case "channel_name": Name = CommandDeserializer.DeserializeString(value); break;			case "channel_topic": Topic = CommandDeserializer.DeserializeString(value); break;			case "channel_flag_default": IsDefaultChannel = CommandDeserializer.DeserializeBool(value); break;			case "channel_flag_password": HasPassword = CommandDeserializer.DeserializeBool(value); break;			case "channel_flag_permanent": IsPermanent = CommandDeserializer.DeserializeBool(value); break;			case "channel_flag_semi_permanent": IsSemiPermanent = CommandDeserializer.DeserializeBool(value); break;			case "channel_codec": Codec = CommandDeserializer.DeserializeEnum<Codec>(value); break;			case "channel_codec_quality": CodecQuality = CommandDeserializer.DeserializeInt32(value); break;			case "channel_needed_talk_power": NeededTalkPower = CommandDeserializer.DeserializeInt32(value); break;			case "channel_icon_id": IconId = CommandDeserializer.DeserializeInt64(value); break;			case "channel_maxclients": MaxClients = CommandDeserializer.DeserializeInt32(value); break;			case "channel_maxfamilyclients": MaxFamilyClients = CommandDeserializer.DeserializeInt32(value); break;			case "channel_codec_latency_factor": CodecLatencyFactor = CommandDeserializer.DeserializeInt32(value); break;			case "channel_codec_is_unencrypted": IsUnencrypted = CommandDeserializer.DeserializeBool(value); break;			case "channel_delete_delay": DeleteDelay = CommandDeserializer.DeserializeTimeSpanSeconds(value); break;			case "channel_flag_maxclients_unlimited": IsMaxClientsUnlimited = CommandDeserializer.DeserializeBool(value); break;			case "channel_flag_maxfamilyclients_unlimited": IsMaxFamilyClientsUnlimited = CommandDeserializer.DeserializeBool(value); break;			case "channel_flag_maxfamilyclients_inherited": IsMaxFamilyClientsInherited = CommandDeserializer.DeserializeBool(value); break;			case "channel_name_phonetic": PhoneticName = CommandDeserializer.DeserializeString(value); break;			case "reasonid": Reason = CommandDeserializer.DeserializeEnum<MoveReason>(value); break;			
			}
		}
	}
	...
	public sealed class ChannelMoved : INotification  
	{
		...
		public int Order { get; set; }		public ChannelIdT ChannelId { get; set; }		public ClientIdT InvokerId { get; set; }		public string InvokerName { get; set; }		public ClientUidT InvokerUid { get; set; }		public MoveReason Reason { get; set; }		public ChannelIdT ChannelParentId { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "order": Order = CommandDeserializer.DeserializeInt32(value); break;			case "cid": ChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "invokerid": InvokerId = CommandDeserializer.DeserializeUInt16(value); break;			case "invokername": InvokerName = CommandDeserializer.DeserializeString(value); break;			case "invokeruid": InvokerUid = CommandDeserializer.DeserializeString(value); break;			case "reasonid": Reason = CommandDeserializer.DeserializeEnum<MoveReason>(value); break;			case "cpid": ChannelParentId = CommandDeserializer.DeserializeUInt64(value); break;			
			}
		}
	}
	...
	public sealed class ChannelSubscribed : INotification  
	{
		...
		public ChannelIdT ChannelId { get; set; }		public TimeSpanSecondsT EmptySince { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "cid": ChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "es": EmptySince = CommandDeserializer.DeserializeTimeSpanSeconds(value); break;			
			}
		}
	}
	...
	public sealed class ClientChannelGroupChanged : INotification  
	{
		...
		public ClientIdT InvokerId { get; set; }		public string InvokerName { get; set; }		public ChannelGroupIdT ChannelGroupId { get; set; }		public ChannelGroupIdT ChannelGroupIndex { get; set; }		public ChannelIdT ChannelId { get; set; }		public ClientIdT ClientId { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "invokerid": InvokerId = CommandDeserializer.DeserializeUInt16(value); break;			case "invokername": InvokerName = CommandDeserializer.DeserializeString(value); break;			case "cgid": ChannelGroupId = CommandDeserializer.DeserializeUInt64(value); break;			case "cgi": ChannelGroupIndex = CommandDeserializer.DeserializeUInt64(value); break;			case "cid": ChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "clid": ClientId = CommandDeserializer.DeserializeUInt16(value); break;			
			}
		}
	}
	public sealed class ClientChatComposing : INotification  
	{
		...
		public ClientIdT ClientId { get; set; }		public ClientUidT ClientUid { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "clid": ClientId = CommandDeserializer.DeserializeUInt16(value); break;			case "cluid": ClientUid = CommandDeserializer.DeserializeString(value); break;			
			}
		}
	}
	...
	public sealed class ClientLeftView : INotification  
	{
		...
		public string ReasonMessage { get; set; }		public TimeSpanSecondsT BanTime { get; set; }		public MoveReason Reason { get; set; }		public ChannelIdT TargetChannelId { get; set; }		public ClientIdT InvokerId { get; set; }		public string InvokerName { get; set; }		public ClientUidT InvokerUid { get; set; }		public ClientIdT ClientId { get; set; }		public ChannelIdT SourceChannelId { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "reasonmsg": ReasonMessage = CommandDeserializer.DeserializeString(value); break;			case "bantime": BanTime = CommandDeserializer.DeserializeTimeSpanSeconds(value); break;			case "reasonid": Reason = CommandDeserializer.DeserializeEnum<MoveReason>(value); break;			case "ctid": TargetChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "invokerid": InvokerId = CommandDeserializer.DeserializeUInt16(value); break;			case "invokername": InvokerName = CommandDeserializer.DeserializeString(value); break;			case "invokeruid": InvokerUid = CommandDeserializer.DeserializeString(value); break;			case "clid": ClientId = CommandDeserializer.DeserializeUInt16(value); break;			case "cfid": SourceChannelId = CommandDeserializer.DeserializeUInt64(value); break;			
			}
		}
	}
	public sealed class ClientMoved : INotification  
	{
		...
		public ClientIdT ClientId { get; set; }		public MoveReason Reason { get; set; }		public ChannelIdT TargetChannelId { get; set; }		public ClientIdT InvokerId { get; set; }		public string InvokerName { get; set; }		public ClientUidT InvokerUid { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "clid": ClientId = CommandDeserializer.DeserializeUInt16(value); break;			case "reasonid": Reason = CommandDeserializer.DeserializeEnum<MoveReason>(value); break;			case "ctid": TargetChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "invokerid": InvokerId = CommandDeserializer.DeserializeUInt16(value); break;			case "invokername": InvokerName = CommandDeserializer.DeserializeString(value); break;			case "invokeruid": InvokerUid = CommandDeserializer.DeserializeString(value); break;			
			}
		}
	}
	public sealed class ClientNeededPermissions : INotification  
	{
		...
		public PermissionId PermissionId { get; set; }		public int PermissionValue { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "permid": PermissionId = (PermissionId)CommandDeserializer.DeserializeInt32(value); break;			case "permvalue": PermissionValue = CommandDeserializer.DeserializeInt32(value); break;			
			}
		}
	}
	public sealed class ClientServerGroupAdded : INotification  
	{
		...
		public string Name { get; set; }		public ServerGroupIdT ServerGroupId { get; set; }		public ClientIdT InvokerId { get; set; }		public string InvokerName { get; set; }		public ClientUidT InvokerUid { get; set; }		public ClientIdT ClientId { get; set; }		public ClientUidT ClientUid { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "name": Name = CommandDeserializer.DeserializeString(value); break;			case "sgid": ServerGroupId = CommandDeserializer.DeserializeUInt64(value); break;			case "invokerid": InvokerId = CommandDeserializer.DeserializeUInt16(value); break;			case "invokername": InvokerName = CommandDeserializer.DeserializeString(value); break;			case "invokeruid": InvokerUid = CommandDeserializer.DeserializeString(value); break;			case "clid": ClientId = CommandDeserializer.DeserializeUInt16(value); break;			case "cluid": ClientUid = CommandDeserializer.DeserializeString(value); break;			
			}
		}
	}
	public sealed class CommandError : INotification  
	{
		...
		public Ts3ErrorCode Id { get; set; }		public string Message { get; set; }		public PermissionId MissingPermissionId { get; set; }		public string ReturnCode { get; set; }		public string ExtraMessage { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "id": Id = (Ts3ErrorCode)CommandDeserializer.DeserializeUInt16(value); break;			case "msg": Message = CommandDeserializer.DeserializeString(value); break;			case "failed_permid": MissingPermissionId = (PermissionId)CommandDeserializer.DeserializeInt32(value); break;			case "return_code": ReturnCode = CommandDeserializer.DeserializeString(value); break;			case "extra_msg": ExtraMessage = CommandDeserializer.DeserializeString(value); break;			
			}
		}
	}
	...
	public sealed class FileListFinished : INotification  
	{
		...
		public ChannelIdT ChannelId { get; set; }		public string Path { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "cid": ChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "path": Path = CommandDeserializer.DeserializeString(value); break;			
			}
		}
	}
	public sealed class FileTransferStatus : INotification  
	{
		...
		public ushort ClientFileTransferId { get; set; }		public Ts3ErrorCode Status { get; set; }		public string Message { get; set; }		public long Size { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "clientftfid": ClientFileTransferId = CommandDeserializer.DeserializeUInt16(value); break;			case "status": Status = (Ts3ErrorCode)CommandDeserializer.DeserializeUInt16(value); break;			case "msg": Message = CommandDeserializer.DeserializeString(value); break;			case "size": Size = CommandDeserializer.DeserializeInt64(value); break;			
			}
		}
	}
	public sealed class InitIvExpand : INotification  
	{
		...
		public string Alpha { get; set; }		public string Beta { get; set; }		public string Omega { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "alpha": Alpha = CommandDeserializer.DeserializeString(value); break;			case "beta": Beta = CommandDeserializer.DeserializeString(value); break;			case "omega": Omega = CommandDeserializer.DeserializeString(value); break;			
			}
		}
	}
	...
	public sealed class ServerEdited : INotification  
	{
		...
		public ClientIdT InvokerId { get; set; }		public string InvokerName { get; set; }		public ClientUidT InvokerUid { get; set; }		public MoveReason Reason { get; set; }		public string ServerName { get; set; }		public CodecEncryptionMode CodecEncryptionMode { get; set; }		public ServerGroupIdT DefaultServerGroup { get; set; }		public ChannelGroupIdT DefaultChannelGroup { get; set; }		public string HostbannerUrl { get; set; }		public string HostbannerGfxUrl { get; set; }		public TimeSpanSecondsT HostbannerGfxInterval { get; set; }		public float PrioritySpeakerDimmModificator { get; set; }		public string HostbuttonTooltip { get; set; }		public string HostbuttonUrl { get; set; }		public string HostbuttonGfxUrl { get; set; }		public string PhoneticName { get; set; }		public ulong IconId { get; set; }		public HostBannerMode HostbannerMode { get; set; }		public TimeSpanSecondsT DefaultTempChannelDeleteDelay { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "invokerid": InvokerId = CommandDeserializer.DeserializeUInt16(value); break;			case "invokername": InvokerName = CommandDeserializer.DeserializeString(value); break;			case "invokeruid": InvokerUid = CommandDeserializer.DeserializeString(value); break;			case "reasonid": Reason = CommandDeserializer.DeserializeEnum<MoveReason>(value); break;			case "virtualserver_name": ServerName = CommandDeserializer.DeserializeString(value); break;			case "virtualserver_codec_encryption_mode": CodecEncryptionMode = CommandDeserializer.DeserializeEnum<CodecEncryptionMode>(value); break;			case "virtualserver_default_server_group": DefaultServerGroup = CommandDeserializer.DeserializeUInt64(value); break;			case "virtualserver_default_channel_group": DefaultChannelGroup = CommandDeserializer.DeserializeUInt64(value); break;			case "virtualserver_hostbanner_url": HostbannerUrl = CommandDeserializer.DeserializeString(value); break;			case "virtualserver_hostbanner_gfx_url": HostbannerGfxUrl = CommandDeserializer.DeserializeString(value); break;			case "virtualserver_hostbanner_gfx_interval": HostbannerGfxInterval = CommandDeserializer.DeserializeTimeSpanSeconds(value); break;			case "virtualserver_priority_speaker_dimm_modificator": PrioritySpeakerDimmModificator = CommandDeserializer.DeserializeSingle(value); break;			case "virtualserver_hostbutton_tooltip": HostbuttonTooltip = CommandDeserializer.DeserializeString(value); break;			case "virtualserver_hostbutton_url": HostbuttonUrl = CommandDeserializer.DeserializeString(value); break;			case "virtualserver_hostbutton_gfx_url": HostbuttonGfxUrl = CommandDeserializer.DeserializeString(value); break;			case "virtualserver_name_phonetic": PhoneticName = CommandDeserializer.DeserializeString(value); break;			case "virtualserver_icon_id": IconId = CommandDeserializer.DeserializeUInt64(value); break;			case "virtualserver_hostbanner_mode": HostbannerMode = CommandDeserializer.DeserializeEnum<HostBannerMode>(value); break;			case "virtualserver_channel_temp_delete_delay_default": DefaultTempChannelDeleteDelay = CommandDeserializer.DeserializeTimeSpanSeconds(value); break;			
			}
		}
	}
	public sealed class ServerGroupList : INotification  
	{
		...
		public ServerGroupIdT ServerGroupId { get; set; }		public string Name { get; set; }		public PermissionGroupDatabaseType GroupType { get; set; }		public int IconId { get; set; }		public bool GroupIsPermanent { get; set; }		public int SortId { get; set; }		public GroupNamingMode NamingMode { get; set; }		public int NeededModifyPower { get; set; }		public int NeededMemberAddPower { get; set; }		public int NeededMemberRemovePower { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "sgid": ServerGroupId = CommandDeserializer.DeserializeUInt64(value); break;			case "name": Name = CommandDeserializer.DeserializeString(value); break;			case "type": GroupType = CommandDeserializer.DeserializeEnum<PermissionGroupDatabaseType>(value); break;			case "iconid": IconId = CommandDeserializer.DeserializeInt32(value); break;			case "savedb": GroupIsPermanent = CommandDeserializer.DeserializeBool(value); break;			case "sortid": SortId = CommandDeserializer.DeserializeInt32(value); break;			case "namemode": NamingMode = CommandDeserializer.DeserializeEnum<GroupNamingMode>(value); break;			case "n_modifyp": NeededModifyPower = CommandDeserializer.DeserializeInt32(value); break;			case "n_member_addp": NeededMemberAddPower = CommandDeserializer.DeserializeInt32(value); break;			case "n_member_remove_p": NeededMemberRemovePower = CommandDeserializer.DeserializeInt32(value); break;			
			}
		}
	}
	public sealed class TextMessage : INotification  
	{
		...
		public TextMessageTargetMode Target { get; set; }		public string Message { get; set; }		public ClientIdT TargetClientId { get; set; }		public ClientIdT InvokerId { get; set; }		public string InvokerName { get; set; }		public ClientUidT InvokerUid { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "targetmode": Target = CommandDeserializer.DeserializeEnum<TextMessageTargetMode>(value); break;			case "msg": Message = CommandDeserializer.DeserializeString(value); break;			case "target": TargetClientId = CommandDeserializer.DeserializeUInt16(value); break;			case "invokerid": InvokerId = CommandDeserializer.DeserializeUInt16(value); break;			case "invokername": InvokerName = CommandDeserializer.DeserializeString(value); break;			case "invokeruid": InvokerUid = CommandDeserializer.DeserializeString(value); break;			
			}
		}
	}
	public sealed class TokenUsed : INotification  
	{
		...
		public string UsedToken { get; set; }		public string TokenCustomSet { get; set; }		public string Token1 { get; set; }		public string Token2 { get; set; }		public ClientIdT ClientId { get; set; }		public ClientDbIdT ClientDbId { get; set; }		public ClientUidT ClientUid { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "token": UsedToken = CommandDeserializer.DeserializeString(value); break;			case "tokencustomset": TokenCustomSet = CommandDeserializer.DeserializeString(value); break;			case "token1": Token1 = CommandDeserializer.DeserializeString(value); break;			case "token2": Token2 = CommandDeserializer.DeserializeString(value); break;			case "clid": ClientId = CommandDeserializer.DeserializeUInt16(value); break;			case "cldbid": ClientDbId = CommandDeserializer.DeserializeUInt64(value); break;			case "cluid": ClientUid = CommandDeserializer.DeserializeString(value); break;			
			}
		}
	}
	...
	public sealed class ClientData :   IResponse
	{
		...
		public string ReturnCode { get; set; }
		public ClientIdT ClientId { get; set; }		public ClientUidT Uid { get; set; }		public ChannelIdT ChannelId { get; set; }		public ClientDbIdT DatabaseId { get; set; }		public string NickName { get; set; }		public ClientType ClientType { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "clid": ClientId = CommandDeserializer.DeserializeUInt16(value); break;			case "client_unique_identifier": Uid = CommandDeserializer.DeserializeString(value); break;			case "cid": ChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "client_database_id": DatabaseId = CommandDeserializer.DeserializeUInt64(value); break;			case "client_nickname": NickName = CommandDeserializer.DeserializeString(value); break;			case "client_type": ClientType = CommandDeserializer.DeserializeEnum<ClientType>(value); break;			case "return_code": ReturnCode = CommandDeserializer.DeserializeString(value); break;
			}
		}
	}
	...
	public sealed class ServerGroupAddResponse :   IResponse
	{
		...
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "sgid": ServerGroupId = CommandDeserializer.DeserializeUInt64(value); break;			case "return_code": ReturnCode = CommandDeserializer.DeserializeString(value); break;
			}
		}
	}
	public sealed class WhoAmI :   IResponse
	{
		...
		public string ReturnCode { get; set; }
		public ClientIdT ClientId { get; set; }		public ChannelIdT ChannelId { get; set; }		public string NickName { get; set; }		public ClientDbIdT DatabaseId { get; set; }		public string LoginName { get; set; }		public ulong OriginServerId { get; set; }		public ulong VirtualServerId { get; set; }		public ClientUidT VirtualServerUid { get; set; }		public ushort VirtualServerPort { get; set; }		public string VirtualServerStatus { get; set; }		public ClientUidT Uid { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "client_id": ClientId = CommandDeserializer.DeserializeUInt16(value); break;			case "client_channel_id": ChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "client_nickname": NickName = CommandDeserializer.DeserializeString(value); break;			case "client_database_id": DatabaseId = CommandDeserializer.DeserializeUInt64(value); break;			case "client_login_name": LoginName = CommandDeserializer.DeserializeString(value); break;			case "client_origin_server_id": OriginServerId = CommandDeserializer.DeserializeUInt64(value); break;			case "virtualserver_id": VirtualServerId = CommandDeserializer.DeserializeUInt64(value); break;			case "virtualserver_unique_identifier": VirtualServerUid = CommandDeserializer.DeserializeString(value); break;			case "virtualserver_port": VirtualServerPort = CommandDeserializer.DeserializeUInt16(value); break;			case "virtualserver_status": VirtualServerStatus = CommandDeserializer.DeserializeString(value); break;			case "client_unique_identifier": Uid = CommandDeserializer.DeserializeString(value); break;			case "return_code": ReturnCode = CommandDeserializer.DeserializeString(value); break;
			}
		}
	}
	public sealed class ClientServerGroup : INotification , IResponse
	{
		...
		public string ReturnCode { get; set; }
		public string Name { get; set; }		public ServerGroupIdT ServerGroupId { get; set; }		public ClientDbIdT ClientDbId { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "name": Name = CommandDeserializer.DeserializeString(value); break;			case "sgid": ServerGroupId = CommandDeserializer.DeserializeUInt64(value); break;			case "cldbid": ClientDbId = CommandDeserializer.DeserializeUInt64(value); break;			
			}
		}
	}
	public sealed class FileDownload : INotification , IResponse
	{
		...
		public string ReturnCode { get; set; }
		public ushort ClientFileTransferId { get; set; }		public ushort ServerFileTransferId { get; set; }		public string FileTransferKey { get; set; }		public ushort Port { get; set; }		public long Size { get; set; }		public string Message { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "clientftfid": ClientFileTransferId = CommandDeserializer.DeserializeUInt16(value); break;			case "serverftfid": ServerFileTransferId = CommandDeserializer.DeserializeUInt16(value); break;			case "ftkey": FileTransferKey = CommandDeserializer.DeserializeString(value); break;			case "port": Port = CommandDeserializer.DeserializeUInt16(value); break;			case "size": Size = CommandDeserializer.DeserializeInt64(value); break;			case "msg": Message = CommandDeserializer.DeserializeString(value); break;			
			}
		}
	}
	public sealed class FileInfoTs : INotification , IResponse
	{
		...
		public string ReturnCode { get; set; }
		public ChannelIdT ChannelId { get; set; }		public string Path { get; set; }		public string Name { get; set; }		public long Size { get; set; }		public DateTime DateTime { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "cid": ChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "path": Path = CommandDeserializer.DeserializeString(value); break;			case "name": Name = CommandDeserializer.DeserializeString(value); break;			case "size": Size = CommandDeserializer.DeserializeInt64(value); break;			case "datetime": DateTime = CommandDeserializer.DeserializeDateTime(value); break;			
			}
		}
	}
	public sealed class FileList : INotification , IResponse
	{
		...
		public string ReturnCode { get; set; }
		public ChannelIdT ChannelId { get; set; }		public string Path { get; set; }		public string Name { get; set; }		public long Size { get; set; }		public DateTime DateTime { get; set; }		public bool IsFile { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "cid": ChannelId = CommandDeserializer.DeserializeUInt64(value); break;			case "path": Path = CommandDeserializer.DeserializeString(value); break;			case "name": Name = CommandDeserializer.DeserializeString(value); break;			case "size": Size = CommandDeserializer.DeserializeInt64(value); break;			case "datetime": DateTime = CommandDeserializer.DeserializeDateTime(value); break;			case "type": IsFile = CommandDeserializer.DeserializeBool(value); break;			
			}
		}
	}
	public sealed class FileTransfer : INotification , IResponse
	{
		...
		public string ReturnCode { get; set; }
		public ClientIdT ClientId { get; set; }		public string Path { get; set; }		public string Name { get; set; }		public long Size { get; set; }		public long SizeDone { get; set; }		public ushort ClientFileTransferId { get; set; }		public ushort ServerFileTransferId { get; set; }		public ulong Sender { get; set; }		public int Status { get; set; }		public float CurrentSpeed { get; set; }		public float AverageSpeed { get; set; }		public TimeSpanSecondsT Runtime { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
			case "clid": ClientId = CommandDeserializer.DeserializeUInt16(value); break;			case "path": Path = CommandDeserializer.DeserializeString(value); break;			case "name": Name = CommandDeserializer.DeserializeString(value); break;			case "size": Size = CommandDeserializer.DeserializeInt64(value); break;			case "sizedone": SizeDone = CommandDeserializer.DeserializeInt64(value); break;			case "clientftfid": ClientFileTransferId = CommandDeserializer.DeserializeUInt16(value); break;			case "serverftfid": ServerFileTransferId = CommandDeserializer.DeserializeUInt16(value); break;			case "sender": Sender = CommandDeserializer.DeserializeUInt64(value); break;			case "status": Status = CommandDeserializer.DeserializeInt32(value); break;			case "current_speed": CurrentSpeed = CommandDeserializer.DeserializeSingle(value); break;			case "average_speed": AverageSpeed = CommandDeserializer.DeserializeSingle(value); break;			case "runtime": Runtime = CommandDeserializer.DeserializeTimeSpanSeconds(value); break;			
			}
		}
	}
	public sealed class FileUpload : INotification , IResponse
	{
		...
		public string ReturnCode { get; set; }
		public ushort ClientFileTransferId { get; set; }		public ushort ServerFileTransferId { get; set; }		public string FileTransferKey { get; set; }		public ushort Port { get; set; }		public long SeekPosistion { get; set; }		public string Message { get; set; }
		public void SetField(string name, string value)
		{
			switch(name)
			{
